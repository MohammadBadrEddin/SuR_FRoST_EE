...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{Abbildung/placeholder.png}
    \caption{Simulink-Modell des Positionsregelkreises. Die obere Reihe bildet Regler und
             Aktor ab, der untere Zweig das Messglied. Der Zweig rechts unten berechnet
             die Kraft aus der Position und ist nicht Teil des Regelkreises
...
Abbildung \ref{fig:simulink_position} unmittelbar ablesen: Von seinem Ausgang führt kein
